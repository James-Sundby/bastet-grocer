...
export default function ListManager({
	...
	const handleRename = async (event) => {
		...
		try {
			const renamedList = await onRenameList(activeListId, trimmedRenameTitle);
			...
			>
				<div className="modal-box max-h-[85vh] w-[92vw] max-w-md overflow-y-auto text-left">
					<div className="flex items-start justify-between gap-4">
						<div>
							<h3 id="list-manager-title" className="text-xl font-bold">
					...
					<div className="mt-5 flex flex-col gap-4">
						...
						<form className="form-control w-full" onSubmit={handleCreate}>
							<div className="label">
								<span className="label-text font-bold">Create a New List</span>
							</div>
						...
						<div className="card card-sm bg-error/10">
							<div className="card-body">
								<p className="card-title text-error">Delete Current List</p>
