...
export default function ItemCard({
    ...
    return (
        <li>
            <article
                className={`card card-sm border border-base-300 bg-base-100 shadow-sm transition-opacity ${completed ? "opacity-50" : ""
                    }`}
            >
                    ...
                    <div className="flex items-start justify-between gap-3">
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div className="min-w-0">
                                    ...
                                    <div className="mt-2 flex flex-wrap gap-2">
                                        ...
                                        <span className="badge badge-neutral badge-outline capitalize wrap-break-word h-auto">
                                            {category}
                                        </span>
                                    </div>
                                </div>
                        ...
                        <div className="flex shrink-0 items-center gap-2">
                            ...
                            <button
                                ...
                                aria-label={
                                    isActionsOpen ? `Close ${name} options` : `Open ${name} options`
                                }
                                title={
                                    isActionsOpen ? `Close ${name} options` : `Open ${name} options`
                                }
