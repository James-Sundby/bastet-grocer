...
export default function NewItemForm({
	...
	const currentSuggestion = suggestCategory ? suggestCategory(name) : null;
	...
	return (
		<section className="w-full">
			<div
				className={`collapse collapse-arrow rounded-md border border-base-300 bg-primary`}
			>
				<input
					type="checkbox"
					id={collapseId}
				...
				<div
					className={`collapse-content bg-base-100 ${isChecked ? "border-t border-base-300" : ""}`}
				>
						...
						<div className="grid grid-cols-[5rem_1fr] gap-2">
							...
							<label className="form-control">
								...
								<select
									...
									value={category}
									aria-describedby={
										isShowingAutomaticSuggestion ? categoryHelpId : undefined
									}
									onChange={(event) => {
